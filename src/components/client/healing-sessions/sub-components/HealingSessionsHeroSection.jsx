...
const HealingSessionsHeroSection = () => {
  return (
    <article className="contentDirectoryBannerSec__wr healingSessionsContentDirectoryBnrSec__wr">
...
export default HealingSessionsHeroSection;
