...
const PractitionerVerifyOTP = ({ closeModal, personalSignUpOpenModal }) => {
  ...
  // Practitioner Personal Sign Up Modal Open
  const handlePractitionerPersonalSignUp = () => {
    handleClose();

    setTimeout(() => {
      personalSignUpOpenModal();
    }, 200);
  };
      ...
      >
        <form className="modal-content">
          <div className="modal-header text-center">
            ...
            <h5 className="modal-title" id="practitionerOTPModalLabel">
            ...
            <div className="form-row">
              ...
              <div className="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 btnParent__wr">
                <button
                  ...
                  onClick={handlePractitionerPersonalSignUp}
                  // data-toggle="modal"
                  // data-target="#practitionerPersonalModal__wr"
                  // data-dismiss="modal"
                >
                  Verify
                </button>
...
export default PractitionerVerifyOTP;
