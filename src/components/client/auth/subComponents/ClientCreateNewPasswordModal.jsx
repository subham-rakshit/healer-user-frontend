...
const ClientCreateNewPasswordModal = ({ closeModal, verifyOTPOpenModal }) => {
      ...
      >
        <form className="modal-content">
          <div className="modal-header text-center">
            ...
            <h5 className="modal-title" id="newPassModalLabel">
              Create New Passowrd
            </h5>
...
export default ClientCreateNewPasswordModal;
