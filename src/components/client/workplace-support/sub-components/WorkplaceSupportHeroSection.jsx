...
const WorkplaceSupportHeroSection = () => {
  return (
    <>
          ...
          <nav aria-label="breadcrumb breadCrumbNav__wr">
            <ol className="breadcrumb breadCrumbWrap__wr">
              ...
              <li
                ...
                aria-current="page"
              >
                <span className="labelText__wr">Workplace Support</span>
              </li>
            </ol>
          </nav>
        </div>
...
export default WorkplaceSupportHeroSection;
