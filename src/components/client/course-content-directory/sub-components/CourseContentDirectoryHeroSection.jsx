...
const CourseContentDirectoryHeroSection = () => {
  return (
    <article className="contentDirectoryBannerSec__wr coursesContentDirectoryBnrSec__wr">
...
export default CourseContentDirectoryHeroSection;
