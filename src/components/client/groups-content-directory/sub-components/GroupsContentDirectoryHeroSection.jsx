...
const GroupsContentDirectoryHeroSection = () => {
  return (
    <article className="contentDirectoryBannerSec__wr groupsContentDirectoryBnrSec__wr">
...
export default GroupsContentDirectoryHeroSection;
