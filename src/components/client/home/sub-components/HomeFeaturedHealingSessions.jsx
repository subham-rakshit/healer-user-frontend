...
import { featured_healing_sessions } from "../../../../assets/data/home-page";

// Import Swiper styles
import "swiper/css";

const HomeFeaturedHealingSessions = () => {
  const swiperRef = useRef(null);

  return (
    <article className="sessionSec__wr featuredHealingSec__wr">
      <div className="container w_lg_max_1600px__wr w_md_max_100_per__wr px_lg_74px__wr">
        <div className="headingParentWrap__wr sessionSecHead__wr featuredHealingSessionSecHead__wr">
          <div className="titleParentWrap__wr sessionSecTitleWrap__wr featuredHealingSessionSecTitleWrap__wr">
            <h2 className="secTitle__wr sessionSecTitle__wr featuredHealingSessionSecTitle__wr">
              Featured Healing Sessions
            </h2>
          </div>
          <div className="btnParent__wr sessionSecHeadBtnParent__wr featuredHealingSessionSecHeadBtnParent__wr">
            <button
              type="button"
      ...
      <div className="container w_lg_max_1600px__wr w_md_max_100_per__wr px_lg_37_5px__wr">
        <div className="swiper_wr">
          ...
          >
            {featured_healing_sessions.map((session) => (
              <SwiperSlide key={session.id}>
                <div className="sessionSliderCard__wr">
                  <picture className="sessionSliderFigure__wr firstAspect__wr">
                    <a href="#">
                      <img
                        src={session.image}
                        loading="lazy"
                    ...
                    {!session.hiddenButtons && (
                      ...
                      >
                        ...
                        <p className="labelText__wr">
                          <span className="date__wr">{session.date}</span> •{" "}
                          <span className="time__wr">{session.time}</span>
                        </p>
                      </button>
                    )}
                  </picture>
                  <div className="card-body sessionSliderBody__wr">
                    <div className="sessionSliderNameWrap__wr">
                      <h6 className="sessionSliderHeelarName__wr">
                        <a href="javascript:void(0);">{session.healer}</a>
                      </h6>
                      {!session.hiddenButtons && (
                        <button
                          type="button"
                    ...
                    <p className="sessionSliderGroupName">
                      <a href="javascript:void(0);">{session.group}</a>
                    </p>
                  </div>
                </div>
              </SwiperSlide>
...
export default HomeFeaturedHealingSessions;
