...
import { circles } from "../../../../assets/data/home-page";
...
const HomeCircles = () => {
  ...
  return (
    <article className="sessionSec__wr circleSessionSec__wr">
      <div className="container w_lg_max_1600px__wr w_md_max_100_per__wr px_lg_74px__wr">
        <div className="headingParentWrap__wr sessionSecHead__wr circleSessionSecHead__wr">
          <div className="titleParentWrap__wr sessionSecTitleWrap__wr circleSessionSecTitleWrap__wr">
            <h2 className="secTitle__wr sessionSecTitle__wr circleSessionSecTitle__wr textColor_grey_870__wr">
              Circles
            </h2>
          </div>
          <div className="btnParent__wr sessionSecHeadBtnParent__wr circleSessionSecHeadBtnParent__wr">
            <button
              type="button"
            ...
            {circles.map((circle) => (
              <SwiperSlide key={circle.id}>
                <div className="sessionSliderCard__wr">
                  <picture className="circleSliderFigure__wr fourthAspect__wr">
                    <a href="#">
                      <img
                        src={circle.image}
                        loading="lazy"
                    ...
                    {!circle.hiddenButtons && (
                      ...
                      >
                        ...
                        <p className="labelText__wr">
                          <span className="date__wr">{circle.date}</span> •{" "}
                          <span className="time__wr">{circle.time}</span>
                        </p>
                      </button>
                    )}
                  </picture>
                  <div className="card-body sessionSliderBody__wr">
                    <div className="sessionSliderNameWrap__wr">
                      <h6 className="sessionSliderHeelarName__wr">
                        <a href="javascript:void(0);">{circle.healer}</a>
                      </h6>
                      {!circle.hiddenButtons && (
                        <button
                          type="button"
                    ...
                    <h3 className="sessionSliderWorkOutName__wr">
                      <a href="javascript:void(0);">{circle.title}</a>
                    </h3>
                    <p className="sessionSliderGroupName">
                      <a href="javascript:void(0);">{circle.group}</a>
                    </p>
                  </div>
                </div>
              </SwiperSlide>
