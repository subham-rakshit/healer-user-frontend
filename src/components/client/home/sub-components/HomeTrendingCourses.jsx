...
import { popular_courses } from "../../../../assets/data/home-page";
...
const HomeTrendingCourses = () => {
  ...
  return (
    <article className="sessionSec__wr trendingCourseSec__wr">
      <div className="container w_lg_max_1600px__wr w_md_max_100_per__wr px_lg_74px__wr">
        <div className="headingParentWrap__wr sessionSecHead__wr trendingCourseSessionSecHead__wr">
          <div className="titleParentWrap__wr sessionSecTitleWrap__wr trendingCourseSessionSecTitleWrap__wr">
            <h2 className="secTitle__wr sessionSecTitle__wr trendingCourseSessionSecTitle__wr textColor_grey_870__wr">
              Trending Courses
            </h2>
          </div>
          <div className="btnParent__wr sessionSecHeadBtnParent__wr trendingCourseSessionSecHeadBtnParent__wr">
            <button
              type="button"
            ...
            {popular_courses.map((course) => (
              <SwiperSlide key={course.id}>
                <div className="sessionSliderCard__wr">
                  <picture className="sessionSliderFigure__wr secondAspect__wr">
                    <a href="#">
                      <img
                        src={course.image}
                        loading="lazy"
                    ...
                    {!course.hiddenButtons && (
                      ...
                      >
                        ...
                        <p className="labelText__wr">
                          <span className="date__wr">{course.date}</span> •{" "}
                          <span className="time__wr">{course.time}</span>
                        </p>
                      </button>
                    )}
                  </picture>
                  <div className="card-body sessionSliderBody__wr">
                    <div className="sessionSliderNameWrap__wr">
                      <h6 className="sessionSliderHeelarName__wr">
                        <a href="javascript:void(0);">{course.healer}</a>
                      </h6>
                      {!course.hiddenButtons && (
                        <button
                          type="button"
                    ...
                    <p className="sessionSliderGroupName">
                      <a href="javascript:void(0);">{course.group}</a>
                    </p>
                  </div>
                </div>
              </SwiperSlide>
