...
const HomePopularCourses = () => {
  ...
  return (
    <article className="sessionSec__wr popularCourseSec__wr">
      <div className="container w_lg_max_1600px__wr w_md_max_100_per__wr px_lg_74px__wr">
        <div className="headingParentWrap__wr sessionSecHead__wr popularCoursesSessionSecHead__wr">
          <div className="titleParentWrap__wr sessionSecTitleWrap__wr popularCoursesSessionSecTitleWrap__wr">
            <h2 className="secTitle__wr sessionSecTitle__wr popularCoursesSessionSecTitle__wr">
              Popular Courses
            </h2>
          </div>
          <div className="btnParent__wr sessionSecHeadBtnParent__wr popularCoursesSessionSecHeadBtnParent__wr">
            <button
              type="button"
