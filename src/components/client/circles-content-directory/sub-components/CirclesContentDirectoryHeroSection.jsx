...
const CirclesContentDirectoryHeroSection = () => {
  return (
    <article className="contentDirectoryBannerSec__wr circlesContentDirectoryBnrSec__wr">
...
export default CirclesContentDirectoryHeroSection;
