...
const WorkshopContentDirectoryHeroSection = () => {
  return (
    <article className="contentDirectoryBannerSec__wr workshopsContentDirectoryBnrSec__wr">
...
export default WorkshopContentDirectoryHeroSection;
