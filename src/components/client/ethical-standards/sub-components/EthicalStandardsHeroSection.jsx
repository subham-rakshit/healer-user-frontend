...
const EthicalStandardsHeroSection = () => {
  return (
    <article className="twoColContentSec__wr ethicalStandardsBannerSec__wr">
            ...
            <div className="bgBlock__wr bgHalfColBlock__wr ethicalStdBnrSecBgBlock__wr">
              <div className="imageBlockBg__wr ethicalStdBnrSecImageBlockBg__wr">
                <picture className="figure__wr ethicalStdBnrSecFigure__wr aspectSeventhRatio__wr">
                  <img
                    src="/images/ethical-standard-banner-bg.jpg"
                    loading="lazy"
                    decoding="async"
                    className="img-fluid"
                    alt=""
...
export default EthicalStandardsHeroSection;
